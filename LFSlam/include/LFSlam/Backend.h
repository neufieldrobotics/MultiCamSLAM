...
public:
    ...
    void displayMatches(LightFieldFrame *prev_frame, LightFieldFrame *current_frame);
    ...
    gtsam::Pose3 calCompCamPose(LightFieldFrame* lf, int cID);
    ...
    void filterLandmarks(LightFieldFrame *currentFrame, GlobalMap *map, vector<int> &lids_filtered,
    ...
    void filterLandmarksStringent(LightFieldFrame* currentFrame, GlobalMap *map, vector<int> &lids_filtered,
                                  vector<gtsam::Point3> &landmarks, vector<gtsam::Point2> &current_measurements,
                                  vector<gtsam::Point2> &previous_measurements, vector<int> &previous_pose_ids);
